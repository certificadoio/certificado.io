...
interface IGlobal {
    ...
    showModalLimitCertificate: boolean,
    ...
    toggleModalLimitCertificate: () => void,
...
const useGlobal = create<IGlobal>(set => ({
    ...
    showModalLimitCertificate: false,
    searchText: "",
    coursesLength: 0,
    ...
    toggleModalLimitCertificate: () => set(state => ({ showModalLimitCertificate: !state.showModalLimitCertificate })),
